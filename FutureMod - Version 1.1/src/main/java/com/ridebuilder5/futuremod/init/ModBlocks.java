...
import com.ridebuilder5.futuremod.blocks.NuclearBlock;
...
public class ModBlocks {
	...
	public static final Block NEPTUNIUM_BLOCK = new NuclearBlock("neptunium_block", Material.IRON);
	public static final Block PLUTONIUM_BLOCK = new NuclearBlock("plutonium_block", Material.IRON);
	public static final Block AMERICIUM_BLOCK = new NuclearBlock("americium_block", Material.IRON);
	public static final Block CURIUM_BLOCK = new NuclearBlock("curium_block", Material.IRON);
}
