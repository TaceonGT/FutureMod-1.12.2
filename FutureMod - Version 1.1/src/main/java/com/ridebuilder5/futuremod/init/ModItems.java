...
public class ModItems {
	...
	public static final Item RADON_FOOD = new FoodEffectBase("radon_food", 4, 2.5f, false, new PotionEffect(MobEffects.GLOWING, (60*40), 1, true, true));
	public static final Item RADIUM_FOOD = new FoodEffectBase("radium_food", 4, 2.0f, false, new PotionEffect(MobEffects.INSTANT_HEALTH, (60*20), 1, false, true));
}
